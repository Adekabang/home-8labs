...
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 4
slug: blog/personal-asn-ipv6-journey
title: Personal ASN and IPv6 Journey
description: A walkthrough of obtaining a personal ASN and IPv6 allocation, then announcing routes over BGP from a Debian VPS to run your own network space.
authors: adekabang
tags: [ipv6, personal-asn, bgp, vps, debian]
date: 2024-03-25
cover:
  alt: "Tomochi planting an ASN flag on the internet map and announcing an IPv6 route"
  image: ./cover.png
---
...
[Lagrange Website](https://lagrange.cloud/next-level-networking)
...
2. Langsung aja “Create an ASN” di page [LIR Services - Lagrange](https://lagrange.cloud/console/lir)
...
4. Setelah itu akan ada Applicationnya, pilih guided, nanti akan diarahkan untuk proses pembuatan akun dan pembuatan object di RIPE. kalau bingung apa yang di isi bisa juga mengacu ke video dibawah:
    1. Video pembuatan object di RIPE :
        [Rifqi Arief in IPv6 Indonesia Telegram Group](https://t.me/IPv6_Indonesia/104851/110743)
...
1. Pilih VPS pada region EU (kasus saya pilih di Amsterdam 1) [iFog Website](https://ifog.ch/en/vps)
...
5. untuk pengisian Lagrange bisa menggunakan panduan berikut:
    1. Partner 1 ASN: ASN punya iFog atau VPS provider lainnya. [iFog AMS VPS](https://ifog.ch/en/vps/vps-amsterdam)
        
        ![iFOg BGP Details](05-ifog-bgp-details.png)
        
    2. Partner 1 NOC: email dari iFog atau VPS provider lainnya. [iFog NOC Contact](https://fognet.ch/contact)
...
> - [my.bgptunnel.com](https://my.bgptunnel.com/) pake ini om buat presence di EU kalo nanti lepas VPS EU
...
1. Lakukan registrasi di [PeeringDB](https://www.peeringdb.com/register).
...
3. Pre Setup (optional)
    ...
    [Github: Xeoncross/lowendscript](https://github.com/Xeoncross/lowendscript), scope:
