...
Everything self-hosted. No per-request fees. No egress charges. No load balancer bills. Two beefy nodes with Postgres + MinIO replication for under $50/month.
