...
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 4
slug: blog/setup-non-ha-kubernetes-using-k3s
title: Setup Non HA Kubernetes using K3S
description: Build a non-HA Kubernetes cluster with K3s on Ubuntu VMs running in Proxmox, covering server and worker node setup with a shared cluster token.
authors: adekabang
tags: [k8s, k3s, kubernetes, proxmox, ubuntu]
date: 2025-02-25
cover:
  alt: "Tomochi balancing a tray of worker nodes on a single control-plane leg"
  image: ./cover.png
---
