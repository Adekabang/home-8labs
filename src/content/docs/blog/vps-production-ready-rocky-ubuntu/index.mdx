...
description: Harden and deploy a production VPS on Rocky Linux 10 or Ubuntu 26.04 with SSH lockdown, Docker, Traefik, TLS, and monitoring.
date: 2026-06-16T10:00:00
sidebar:
  order: 2
cover:
  alt: "Tomochi stacking Traefik, TLS, firewall and hardening layers onto a bare VPS"
  image: ./cover.png
---
...
> Adapted from [Dreams of Code](https://dreamsofcode.io/blog/setting-up-a-production-ready-vps-from-scratch), a dual-OS guide covering both RHEL-family and Debian-family setups.
...
> **💡 Hosting with a side of nasi goreng?** 🇮🇩 [8labs](https://8labs.id) offers VirtualLabs and ElasticLabs : VPS and scalable infrastructure, straight out of Indonesia. 🤙
...
Typing `ssh deployer@203.0.113.42` every time gets old. Add an entry to your local `~/.ssh/config`:
...
<Tabs>
  <TabItem label="Rocky Linux 10 (firewalld)">
...
```
  ...
  <TabItem label="Ubuntu 26.04 (UFW)">
