...
description: Install the AaPanel web hosting control panel on an IPv6-only server with commands for Ubuntu, Debian, and CentOS, plus dual-stack access tips.
sidebar:
  order: 1
---
