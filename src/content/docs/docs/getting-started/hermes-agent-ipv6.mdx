...
description: Install and run the Nous Research Hermes Agent on an IPv6-only VPS, working around GitHub and GHCR IPv4 limits with proxy or NAT64 setups.
sidebar:
  order: 5
---
...
- [So you got an IPv6-only VPS?](https://sagar.se/blog/ipv6-vps/) — Practical blog about living with an IPv6-only server, including NAT64 setup and service compatibility
- [How to get IPv4 connectivity on an IPv6 only VPS](https://gist.github.com/unixfox/bb299ce4f862fad66ee2e6d9024bef98) — GitHub Gist with comprehensive NAT64/DNS64 and proxy workarounds
- [OpenAI API endpoint does NOT support IPv6](https://www.reddit.com/r/ipv6/comments/17z6l3y/) — r/ipv6 community discussion confirming the issue and sharing workarounds
- [An IPv6-only VPS that costs less](https://news.ycombinator.com/item?id=6818452) — Hacker News discussion (80 comments) on IPv6-only hosting experiences
